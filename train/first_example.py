...
from . import batch
from . import train_process
from model import utils, transformer
...
def data_gen(V, batch_size, nbatches):
    ...
    for _ in range(nbatches):
        ...
        yield batch.Batch(src, tgt, src_pad=0, tgt_pad=0)
...
def example_simple_model():
    V = 11
    criterion = train_process.LabelSmoothing(size=V, padding_idx=0, smoothing=0.0)
